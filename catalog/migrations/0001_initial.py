    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True, verbose_name='Описание')),
                ('img_preview', models.ImageField(blank=True, null=True, upload_to='catalog/', verbose_name='Изображение(превью)')),
                ('pur_price', models.DecimalField(decimal_places=0, max_digits=1000, verbose_name='Цена за покупку')),
